...
SRC_URI = " \
    gitsm://github.com/victronenergy/${BPN}.git;branch=master;protocol=ssh;user=git;tag=v${PV} \
...
DAEMONTOOLS_SERVICE_DIR_SERIAL = "${DEAMONTOOLS_COMMON_TEMPLATES_DIR}/${PN}.serial"
