...
SRC_URI = "\
	gitsm://github.com/victronenergy/venus-bornay.git;protocol=http;branch=master;tag=v${PV} \
"
...
DAEMONTOOLS_LOG_DIR = "${DAEMONTOOLS_LOG_DIR_PREFIX}/bornay-windplus.TTY"
