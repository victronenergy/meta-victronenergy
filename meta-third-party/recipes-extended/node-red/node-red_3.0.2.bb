...
do_install:append() {
    ...
    rm ${D}${nonarch_libdir}/node_modules/${PN}/node_modules/bcrypt/build-tmp-napi-v3/node_gyp_bins/python3
    rmdir ${D}${nonarch_libdir}/node_modules/${PN}/node_modules/bcrypt/build-tmp-napi-v3/node_gyp_bins
}
